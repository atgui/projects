module popup {
	export class Prompt1Popup extends popup.PopupBase implements IView {

		public constructor(titleStr: string, infoStr: string, comeBack: Function, thisObj: any) {
			super();
			...
			this.skinName = "skins/login/Prompt1Popup.exml";
		}
